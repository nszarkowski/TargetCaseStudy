...
#recursion while loop to loop back if you did not enter a correct mount point/want to check another mount point
while True:
    ...
    if ismount == True:
        ...
        print(result)
        continueCheck = input("Do you want to check another mount point: Y/N ")
        if continueCheck.upper() == "Y":
            continue
        print("Bye")
        break 
    else:
